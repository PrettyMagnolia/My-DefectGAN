...
class Trainer(object):
    ...
    def build_models(self):
        ...
        if self.g_model_name == "defectnet":
            self.g_model = defect_generator(spectral_norm=self.g_model_spectral_norm,
        ...
        if self.d_model_name == "path_discriminator":
            self.d_model = defect_discriminator(spectral_norm=self.d_model_spectral_norm,
